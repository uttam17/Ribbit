...
public final class ParseConstants {
    ...
    //Field names
    public static final String KEY_USERNAME = "username";  //public can be accessed anywhere, static can be accessed without a parseConstant object, final can not be modified
